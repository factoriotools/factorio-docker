# Factorio [![](https://images.microbadger.com/badges/image/dtandersen/factorio.svg)](https://microbadger.com/images/dtandersen/factorio "Get your own image badge on microbadger.com") [![Docker Pulls](https://img.shields.io/docker/pulls/dtandersen/factorio.svg)](https://hub.docker.com/r/masterbeef/factorio/) [![Docker Stars](https://img.shields.io/docker/stars/dtandersen/factorio.svg)](https://hub.docker.com/r/masterbeef/factorio/)

* `0.15.31`, `0.15`, `latest`, `stable` [(0.15/Dockerfile)](https://github.com/slaubot/factorio/blob/master/0.15/Dockerfile)
